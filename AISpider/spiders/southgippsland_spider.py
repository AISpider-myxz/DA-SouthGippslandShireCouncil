    ...
    def parse_details2(self, response):
        ...
        try :
            ...
            try:
                ...
                item['app_date'] = temp_data if lodged_date else 0
            except:
                item['app_date'] = 0
            try:
                item['app_location'] = temp_dict['Application Location']
        ...
        try:
            ...
            try:
                ...
                time_array = time.strptime(lodged_date, '%d/%m/%Y')
                temp_data = int(time.mktime(time_array))
                item['actual_started_date'] = temp_data if lodged_date else 0
            except:
            ...
            try:
                ...
                time_array = time.strptime(lodged_date, '%d/%m/%Y')
                temp_data = int(time.mktime(time_array))
                item['actual_completed_date'] = temp_data if lodged_date else 0
            except:
